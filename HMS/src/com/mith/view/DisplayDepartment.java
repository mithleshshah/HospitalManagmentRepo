	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(rs.next())
		{
			...
			out.println("<center><table border=1 width=100%>");
	          ...
	          out.println("<tr><th><font color=skyblue>Department id</font></th><th><font color=skyblue>Department Name</font></th><th><font color=skyblue>Description</font></th><th><font color=skyblue>Action</font></th></tr>");			
			  do
			  {
			 out.println("<tr><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td><a href=DepartmentViewById?deptid="+rs.getString(1)+">Edit/Delete</a></tr>");	  
